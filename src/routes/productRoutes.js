...
import { addCarrinho, addDelProd, deleteProdutos, getCarrinho, getProductByCategory, getProductById, getProducts, limpaCarrinho, postProduct, postProductMany, searchProduct, sendOrder } from "../controllers/product.controller.js";
...
productsRouter.put('/carrinho/:id/:tipo', validateAuth, addDelProd);
